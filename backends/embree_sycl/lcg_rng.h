...
uint32_t lcg_random(LCGRand &rng)
{
...
float lcg_randomf(LCGRand &rng)
{
    return sycl::ldexp((float)lcg_random(rng), -32);
}

LCGRand get_rng(uint32_t pixel_id, uint32_t frame_id)
{
    LCGRand rng;
